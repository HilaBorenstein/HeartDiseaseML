...
class FeatureSelector():
    ...
    def __init__(self,log_file, data, labels=None):
        ...
        #this is the results log file which we will write the feature selection results in it
    ...
    def identify_missing(self, missing_threshold):
        ...
        #print("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~~~Identify Missing values with Treshold of "+str(missing_threshold)+": ~~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        print('%d features with greater than %0.2f missing values.' % (len(self.ops['missing']), self.missing_threshold))
        #printing results to log file
        self.log_file.write("   a.Identify missing values with treshold of "+str(missing_threshold)+"\n")
        self.log_file.write('       %d features with greater than %0.2f missing values.\n' % (len(self.ops['missing']), self.missing_threshold))
        self.log_file.write("\t\t"+str(self.ops['missing'])+"\n")
    ...
    def identify_single_unique(self):
        ...
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~~~~Find Single Unique Value: ~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        print('%d features with a single unique value.' % len(self.ops['single_unique']))
        #printing results to log file
        self.log_file.write("   b.Find single unique value\n")
        self.log_file.write('       %d features with a single unique value.\n' % len(self.ops['single_unique']))
        self.log_file.write("\t\t"+str(self.ops['single_unique'])+"\n")
    ...
    def identify_collinear(self, correlation_threshold, one_hot=False):
        ...
        """
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~Find Collinear Features with Threshold of " +str(correlation_threshold)+": ~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        print('%d features with a correlation magnitude greater than %0.2f.' % (len(self.ops['collinear']), self.correlation_threshold))
        #printing results to log file
        self.log_file.write("   c.Find collinear features with threshold of " +str(correlation_threshold)+"\n")
        self.log_file.write('       %d features with a correlation magnitude greater than %0.2f.\n' % (len(self.ops['collinear']), self.correlation_threshold))
        self.log_file.write("\t\t"+str(self.ops['collinear'])+"\n")
    ...
    def identify_zero_importance(self, task, eval_metric=None, 
        ...
        """
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~~~~Find Zero Importance Features: ~~~~~~~~~~~~~~~~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        #printing results to log file
        self.log_file.write("   d.Find zero importance features\n")
        self.log_file.write('       %d features with zero importance after one-hot encoding.\n' % len(self.ops['zero_importance']))
        self.log_file.write("\t\t"+str(self.ops['zero_importance'])+"\n")
    ...
    def identify_low_importance(self, cumulative_importance):
        ...
        """
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~~~~Find low Importance Features: ~~~~~~~~~~~~~~~~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        self.log_file.write("   e.Find low importance features\n")
        self.log_file.write('       %d features required for cumulative importance of %0.2f after one hot encoding.\n' % (len(self.feature_importances) -
                                                                            len(self.record_low_importance), self.cumulative_importance))
        self.log_file.write('       %d features do not contribute to cumulative importance of %0.2f.\n' % (len(self.ops['low_importance']),
                                                                                               self.cumulative_importance))
        self.log_file.write("\t\t"+str(self.ops['low_importance'])+"\n")
    ...
    def remove(self, methods, keep_one_hot = True):
        ...
        """
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("~~~~~~~~~~~~Removing the irrelevant Features: ~~~~~~~~~~~~~~~~~~~~")
        #print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")   
        features_to_drop = []
        if methods == 'all': 
